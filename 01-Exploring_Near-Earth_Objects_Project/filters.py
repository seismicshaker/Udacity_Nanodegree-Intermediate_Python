...
class DateFilter(AttributeFilter):
    """Date Filter subclass for CloseApproach objects."""

    @classmethod
    def get(cls, approach):
        """Returns CloseApproach date."""
        return approach.time.date()

class DistanceFilter(AttributeFilter):
    """Distance Filter subclass for CloseApproach objects."""

    @classmethod
    def get(cls, approach):
        """Returns CloseApproach distance."""
        return approach.distance

class VelocityFilter(AttributeFilter):
    """Velocity Filter subclass for CloseApproach objects."""

    @classmethod
    def get(cls, approach):
        """Returns CloseApproach velocity."""
        return approach.velocity

class DiameterFilter(AttributeFilter):
    """Diameter Filter subclass for CloseApproach objects."""

    @classmethod
    def get(cls, approach):
        """Returns CloseApproach diameter."""
        return approach.neo.diameter

class HazardousFilter(AttributeFilter):
    """Hazardous Filter subclass for CloseApproach objects."""

    @classmethod
    def get(cls, approach):
        """Returns CloseApproach hazardous."""
